...
namespace Entitas {
    public partial class Entity {
        static readonly RMC.EntitasCoverShooter.Entitas.Components.PlayerComponent playerComponent = new RMC.EntitasCoverShooter.Entitas.Components.PlayerComponent();
